...
of exchange difficulties, a *cost matrix*, $(c_{ij})_{1\leq i\leq n, 1\leq j\leq p}$. For instance
$c_{ij}$ can be the distance between origin $i$ and destination $j$.
...
function as follows (we show the values using a barplot).
