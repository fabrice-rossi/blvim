...
#' and destination locations using [blvim()] on a grid of parameters. The flows
...
#' the alpha values given by `alphas` and the beta values given by `betas`. The
#' function returns an object of class `sim_list` which contains the resulting
#' flows.
#'
#' @inheritParams blvim
