...
// blv
Rcpp::List blv(const arma::mat& costs, const arma::vec& X, double alpha, double beta, const arma::vec& Z_init, const arma::vec& kappa, double epsilon, int iter_max, int conv_check, double precision, bool quadratic, bool use_kappa);
RcppExport SEXP _blvim_blv(SEXP costsSEXP, SEXP XSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP Z_initSEXP, SEXP kappaSEXP, SEXP epsilonSEXP, SEXP iter_maxSEXP, SEXP conv_checkSEXP, SEXP precisionSEXP, SEXP quadraticSEXP, SEXP use_kappaSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type use_kappa(use_kappaSEXP);
    rcpp_result_gen = Rcpp::wrap(blv(costs, X, alpha, beta, Z_init, kappa, epsilon, iter_max, conv_check, precision, quadratic, use_kappa));
...
static const R_CallMethodDef CallEntries[] = {
    {"_blvim_blv", (DL_FUNC) &_blvim_blv, 12},
